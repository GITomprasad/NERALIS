...
4. Module 04: Predictive Disruption Intelligence - Calibrated GBDT ML model (98.4% balanced accuracy, 0.991 ROC-AUC) forecasting landslides/floods 6 to 72 hours ahead using IMD rainfall, Bhuvan DEM slope, and CWC hydrology. Includes Pre-positioning Advisories & Digital Twin stress simulations.
